...
(function(window, undefined) {
	...
	var UAParser = function(uastring, extensions) {
		...
		this.getOS = function() {
			var uas = this.getUA();
			if (new RegExp("Titanium", "i").test(uas)) {
				if (new RegExp("iPhone/([0-9_\\.]*)", "i").exec(uas) != null) {
					var osv = new RegExp("iPhone/([0-9_\\.]*)", "i").exec(uas);
					return {
						"name": "iOS",
						"version": osv[1]
					}
				}
				if (uas.split("/")[0] === "Appcelerator Titanium" && new RegExp("Android\\s([0-9].*);", "i").exec(uas) != null) {
					var osv = new RegExp("Android\\s([0-9].*);", "i").exec(uas);
					return {
						"name": "Android",
						"version": osv[1]
					}
